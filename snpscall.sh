...
wait
for i in {1..14}; do bwa mem -t 5 Danio_rerio.GRCz11.dna.primary_assembly-only-chr.fa trimed/0${i}_1_trim.fastq.gz  trimed/0${i}_2_trim.fastq.gz -o sam/0${i}.sam & done
wait
rm trimed/*
for i in {1..14}
do
